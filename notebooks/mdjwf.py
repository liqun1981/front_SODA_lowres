...
def densmdjwf(s,theta,p):
   ...
   =========================================================================
    ...
    num = ( eosMDJWFnum[11] + t1*(eosMDJWFnum[0] + t1*(eosMDJWFnum[1] + eosMDJWFnum[2]*t1) ) \
	    + s1*(eosMDJWFnum[3] + eosMDJWFnum[4]*t1 + eosMDJWFnum[5]*s1) \
	    + p1*(eosMDJWFnum[6] + eosMDJWFnum[7]*t2 + eosMDJWFnum[8]*s1 \
            + p1*(eosMDJWFnum[9] + eosMDJWFnum[10]*t2) ) )

    den = ( eosMDJWFden[12] + t1*(eosMDJWFden[0] + t1*(eosMDJWFden[1] + t1*(eosMDJWFden[2] \
	    + t1*eosMDJWFden[3] ) ) ) \
            + s1*(eosMDJWFden[4] + t1*(eosMDJWFden[5] + eosMDJWFden[6]*t2) + sp5*(eosMDJWFden[7] \
	    + eosMDJWFden[8]*t2) ) \
